...
export REPLAN_URL="REPLAN_URL/5000/replan_train"

PROJECT_NAME="deepreseach"
EXPERIMENT_NAME=""


SAVE_CHECKPOINT_DIR=/your_path/mmsearch/verl_checkpoints

DATASET_TRAIN=/your_path/datasets/fvqa_train_final.parquet
DATASET_VAL=/your_path/datasets/fvqa_test_final.parquet
REF_MODEL_PATH=/your_path/model/Qwen2.5-VL-7B-Instruct/Qwen/Qwen2.5-VL-7B-Instruct
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.multi_turn.tool_config_path=/your_path/local_search/configs/mm_search_tool_config.yaml \
