...
skip_batch_evaluate = os.getenv("TTRL_SKIP_BATCH_EVALUATE", "0").lower() in ("1", "true", "yes")
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        print(len(batch))
                    response1, response2, response3 = update_external_memory_state()
                    # update critic
                    if self.use_critic:
...
def update_external_memory_state():
    if skip_batch_evaluate:
        response1 = {"status": "skipped", "reason": "TTRL_SKIP_BATCH_EVALUATE=1"}
    else:
