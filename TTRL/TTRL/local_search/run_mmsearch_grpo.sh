...
SAVE_CHECKPOINT_DIR=/your_path/mem-plan-ttrl/fvqa_test/verl_checkpoints
DATASET_TRAIN=/your_path/datasets/TTRL/Explore/2wiki_converted.parquet
DATASET_VAL=/your_path/datasets/TTRL/Explore/2wiki_converted.parquet
